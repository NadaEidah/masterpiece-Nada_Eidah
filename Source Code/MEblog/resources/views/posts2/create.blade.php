    ...
    {{-- <section class="section-1">
        <div class="jumbotron d-flex align-items-center" style="background-color:#AFE5AB ">
            ...
            <div class="container-fluid content">
                <h1 data-aos="fade-right" data-aos-delay="300">Welcome to  create Fun Challenge.</h1>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="contact-info">
                ...
                <h3>Be starte Fun challenges</h3> 
                <p>should have fun from time to time</p>
            </div>
        </div>
       <section class="blog">
       <div id="contact">
              {{-- <div class="row justify-content-center"> --}}
                  <div class="col-md-12">
                      <div class="form-group">
                          {{-- <div class="card-header">create post2</div> --}}
                             <div class="">
                                <div class="container">
                              ...
                              @endif                        
                              <form method="post" action="{{ route('post2.store') }}" enctype="multipart/form-data">
                                     @csrf
                                      ...
                                      <div class="form-group">
                                              ...
                                              <textarea type="text" class="form-control" name="content" placeholder="content" rows="8" cols="8"></textarea>
                                      </div>
