...
.col-md-3{
        ...
        margin-top: 20px;
           ...
           <body>
                ...
                <div class="row">
                        ...
                        <h2>Be Redey to starte challenges</h2> 
    ...
    <form action="{{ route('steps.store') }}" method="POST" name="add_step" >
            {{ csrf_field() }}
             

            <div >
            <h3> Add Step</h3>
              <input type="text" name="step" class="form-control" placeholder="Enter step">
...
{{-- <h2 style="margin-top: 12px;" class="text-center">Add Step</h2>
<br>
